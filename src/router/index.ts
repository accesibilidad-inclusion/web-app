...
import OnboardingWelcome from '../views/onboarding/WelcomeOnboarding.vue';
import NewPlaceOnboarding from '../views/onboarding/NewPlaceOnboarding.vue';
