  ...
  <section class="main-categories container">
    <div class="main-categories__header">
      <h2 class="main-categories__title">
        Facilitamos tu vida en pasos simples
      </h2>
      <p class="main-categories__description">
        Encuentra ayuda por categoría
      </p>
      <text-to-speech :text-audio="'Facilitamos tu vida en pasos simples. Encuentra ayuda por categoría'" />
    </div>
